...
layui.define(["jquery", "miniMenu", "element","miniPage", "miniTheme"], function (exports) {
    ...
    var miniAdmin = {
        ...
        success: function (title) {
            return layer.msg(title, {icon: 1, shade: this.shade, scrollbar: false, time: 800, shadeClose: true});
        },
        ...
        error: function (title) {
            return layer.msg(title, {icon: 2, shade: this.shade, scrollbar: false, time: 1000, shadeClose: true});
        },
